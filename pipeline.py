    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'artwork':
                wget_args.extend(['--warc-header', 'pixiv-artwork: '+item_value])
                wget_args.append('https://www.pixiv.net/en/artworks/'+item_value)
            elif item_type == 'image':
                image_name, image_extension = item_value.split(':', 1)
                url = 'https://i.pximg.net/img-original/img/' + image_name + image_extension
                wget_args.extend(['--warc-header', 'pixiv-master-image: '+url])
...
project = Project(
    title='Pixiv',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/d/dd/Pixiv-icon.png/600px-Pixiv-icon.png" height="50px" title=""/>
        <h2>pixiv.net <span class="links"><a href="https://pixiv.net/">Website</a> &middot; <a href="http://tracker.archiveteam.org/pixiv/">Leaderboard</a></span></h2>
        <p>Archiving Pixiv.</p>
    '''
)
